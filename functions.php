...
function purecss_scripts_styles() {
	...
	wp_enqueue_style( 'purecss-0.6', get_template_directory_uri().'/pure-0.6-min.css', '0.1');
        wp_enqueue_style( 'purecss-grid', get_template_directory_uri().'/grids-responsive-min.css', '0.2');
